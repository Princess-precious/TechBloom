...
function Section4home(){
  return(
    <section id="contact" className="flex bg-[#010e24] h-auto p-8 items-center justify-center">
      <div className="flex flex-col gap-8 items-center md:flex-row bg-[#2c3951] rounded-lg p-8">
